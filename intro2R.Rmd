---
title: "Intro2R Solutions for BU Coding Hour"
...
(BONUS: do this at the command line)

Set your working directory to that directory

```{r}
setwd("~/Documents/daviesLab/codingHour/")
```
...
legend(x = 10, y = 8, c("Week 2", "Week 3"), col=c("green", "pink"), lwd = 5, bty = "n")
```
